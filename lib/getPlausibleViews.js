...
async function getPlausibleViews({ slug }) {
	const url = `https://stats.johnschmidt.cloud/api/v1/stats/aggregate?site_id=interglobalmedianetwork.com&period=custom&date=2022-07-08,${nowDate}&filters=event:page==/blog/${slug}`
	return fetcher(url, {
		headers: {
