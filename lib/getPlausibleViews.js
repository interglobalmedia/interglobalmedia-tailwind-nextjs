...
export default async function getPlausibleViews(frontMatter) {
	...
	const url = `https://stats.interglobalmedianetwork.com/api/v1/stats/aggregate?site_id=jinterglobalmedianetwork.com&period=custom&date=2022-07-08,${nowDate}&filters=event:page==/blog/${slug}`
	return fetcher(url, {
		headers: {
