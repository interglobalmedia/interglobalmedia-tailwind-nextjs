...
> -   ## A. <b className="faqs-b text-base">Inter-Global Media Network, Inc., is Maria Campbell's business name, and she offers web development consultation, operating system (OS) consultation, building applications and web sites, teaching, and one-on-one tutoring the aforementioned subjects.</b>
