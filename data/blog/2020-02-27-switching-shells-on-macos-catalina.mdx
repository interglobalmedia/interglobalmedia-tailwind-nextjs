...
lastmod: '2022-07-15'
tags: ['interactive shell', 'bash', 'zsh']
categories: ['catalina', 'macOS', 'post']
draft: false
summary:
...
images:
    [
        '/static/images/posts/img/webp/christina-victoria-craft-qyPAFcZnwZw-unsplash.webp',
    ]
layout: PostLayout
canonicalUrl: /blog/2020-02-27-switching-shells-on-mac-os-catalina
---

<Unsplash
	src="/static/images/posts/img/webp/christina-victoria-craft-qyPAFcZnwZw-unsplash.webp"
	author="Christina Victoria Craft"
	alt="Switching Shells on macOS Catalina"
	srcUrl="https://unsplash.com/photos/qyPAFcZnwZw"
...
![Switching Shells from Bash to Zsh](/static/images/posts/img/webp/zsh-to-bash-catalina.webp)
