...
lastmod: '2022-07-15'
tags: ['geolocation', 'apis', 'browser scrollbars']
categories: ['cross-browser compatibility', 'post']
draft: false
summary:
    How I solved the issue of moving buttons on click, and what the side effects
    were of that move!
images:
    ['/static/images/posts/img/webp/olivier-miche-skva4bc_bsg-unsplash.webp']
layout: PostLayout
canonicalUrl: /blog/2020-03-02-how-to-prevent-buttons-from-moving-on-click
---

<Unsplash
	src="/static/images/posts/img/webp/olivier-miche-skva4bc_bsg-unsplash.webp"
	author="Olivier Miche"
	alt="How to prevent buttons from moving on click"
	srcUrl="https://unsplash.com/photos/Skva4bc_Bsg"
	authorUrl="https://unsplash.com/@oliviermiche"
/>
