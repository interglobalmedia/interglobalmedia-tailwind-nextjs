...
lastmod: '2022-07-15'
tags: ['sticky-footer']
categories: ['post', 'react', 'nodejs', 'graphql', 'mongodb']
draft: false
summary:
...
layout: PostLayout
canonicalUrl: /blog/2020-01-09-how-to-create-a-sticky-footer-when-you-originally-didnt-account-for-having-one
---

<Unsplash
	src="/static/images/posts/img/webp/markus-winkler-zew4bp2gwva-unsplash.webp"
	author="Markus Winkler"
	alt="How to create a sticky footer when you originally didn't account for having one"
