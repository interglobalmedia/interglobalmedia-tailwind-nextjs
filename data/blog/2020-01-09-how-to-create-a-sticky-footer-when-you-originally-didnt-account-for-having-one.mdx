...
![How to create a sticky footer when you originally didn't account for having one](/static/images/posts/img/webp/stanislav-kondratiev-123540-unsplash.webp)
