...
date: '2022-07-01'
lastmod: '2022-07-16'
tags: ['ajax', 'canvas 2D', 'random colors']
categories: ['canvas 2D', 'project', 'web audio api']
draft: false
summary:
    A Web Audio API app which uses AJAX to retrieve a locally hosted audio file.
images: ['/static/images/projects/img/webp/web-audio-api-ajax.webp']
layout: PostLayout
canonicalUrl: /blog/projects/web-audio-api-ajax
---

<Interglobalmedia
	src="/static/images/projects/img/webp/web-audio-api-ajax.webp"
	author="Maria D. Campbell"
	alt="Web Audio API AJAX"
	srcUrl="/static/images/projects/img/webp/web-audio-api-ajax.webp"
	authorUrl="/about"
/>

## Web Audio API Meets a Sprinkle of Confetti: Confetti By Sound And Color
...
`ajax`, `babel 7`, `buffer`, `canvas 2D`, `cdnjs`, `code refactor`,
`confettijs`, `eslint 8`, `gh-pages`, `modern javascript`, `node sass`, `npm`,
`prettier`, `random colors`, `scripts`, `web audio api`, `webpack 5`,
`workflow refactor`

-   [View Web Audio API AJAX on Github GH Pages](https://interglobalmedia.github.io/web-audio-api-ajax/)

-   [View Web Audio API AJAX Repository on Github](https://github.com/interglobalmedia/web-audio-api-ajax)
