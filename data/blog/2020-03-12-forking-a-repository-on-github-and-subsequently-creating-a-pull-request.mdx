...
categories: ['git', 'post']
draft: false
summary: Forking a repository on Github and subsequently creating a pull request on the original repository.
images: ['/static/images/posts/img/webp/paolo-chiabrando-dmgv2jjshdo-unsplash.webp']
layout: PostLayout
...
After the **_first push_**, you **_no longer_** have to `include -u` in **_subsequent pushes_**. It is **_only necessary_** the **first time** you do so.
