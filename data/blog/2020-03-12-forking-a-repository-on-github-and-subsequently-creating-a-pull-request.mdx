...
images:
    ['/static/images/posts/img/webp/paolo-chiabrando-dmgv2jjshdo-unsplash.webp']
layout: PostLayout
canonicalUrl: /blog/2020-03-12-forking-a-repository-on-github-and-subsequently-creating-a-pull-request-on-the-original-repository
---

<Unsplash
	src="/static/images/posts/img/webp/paolo-chiabrando-dmgv2jjshdo-unsplash.webp"
	author="Paolo Chiabrando"
	alt="Forking A Repository on Github and Subsequently Creating a Pull Request"
	srcUrl="https://unsplash.com/photos/dMGV2jJShdo"
	authorUrl="https://unsplash.com/@chiabra"
/>
...
![Forking a repository](/static/images/posts/img/webp/fork.webp)
...
![git remote -v](/static/images/posts/img/webp/git-remote-v.webp)
...
![git merge upstream/master](/static/images/posts/img/webp/git-merge-upstream-master.webp)
...
If I want to **_make changes_** to my `forked repository` on **Github** so that
I can then **_make_** a `pull request` on the `original repository`, I would
**_do_** the **_following_** before **_pushing changes_** I **have made** to my
`local copy` of my `remote forked repository`:

```shell
git remote set-url origin git@github.com:yourusername/orignalreponame.git
```

This is **_analogous_** to
`git remote add origin git@github.com:yourusername/yourreponame.git` when
**_first pushing_** your `local repository` to your `remote repository` on
**Github**. Now you are ready to create your **_first_** `pull request` on the
**_original_** `repository` you `forked`! And when you want to push those
changes for the first time to your remote forked repository on Github, you would
do the following:
...
**_subsequent pushes_**. It is **_only necessary_** the **first time** you do
so.
