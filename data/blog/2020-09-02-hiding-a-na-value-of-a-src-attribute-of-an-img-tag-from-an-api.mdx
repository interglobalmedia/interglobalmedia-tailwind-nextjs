...
lastmod: '2022-07-15'
tags: ['onerror', 'altext-image', 'src-attribute', 'api']
categories: ['api', 'error-handling', 'post']
draft: false
summary:
    ...
    broken.
images: ['/static/images/posts/img/webp/usgs-k7wetnday6a-unsplash.webp']
layout: PostLayout
canonicalUrl: /blog/2020-09-02-hiding-a-n-a-value-of-a-src-attribute-of-an-img-tag-from-an-api
---

<Unsplash
	src="/static/images/posts/img/webp/usgs-k7wetnday6a-unsplash.webp"
	author="USGS"
	alt="Hiding a 'N/A' value of a src attribute  of an img tag from an API"
	srcUrl="https://unsplash.com/photos/k7WetNdaY6A"
	authorUrl="https://unsplash.com/@usgs"
/>
...
![screenshot of altext image set to none](/static/images/posts/img/webp/screen-shot-2020-09-02-at-10.24.00-am.webp)

And the **page** looked like the **following** in the `browser` (**_no_**
`alternate` **default placeholder** `image`):

![screenshot of altext image successfully removed](/static/images/posts/img/webp/screen-shot-2020-09-02-at-8.50.30-am.webp)
