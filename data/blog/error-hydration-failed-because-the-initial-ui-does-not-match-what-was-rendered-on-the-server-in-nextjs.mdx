...
categories: ['nextjs', 'hydration errors', 'post']
draft: false
summary:
    Error hydration failed because the initial UI does not match what was
    rendered on the server in Next.js.
images: ['/static/images/posts/img/webp/pexels-pixabay-416528.webp']
layout: PostLayout
canonicalUrl: /blog/error-hydration-failed-because-initial-ui-does-not-match-what-was-rendered-on-the-server-in-nextjs
---

<Pexels
	src="/static/images/posts/img/webp/pexels-pixabay-416528.webp"
	author="Pixabay"
	alt=" Error hydration failed because the initial UI does not match what was rendered on the server in Next.js"
	srcUrl="https://www.pexels.com/photo/clean-clear-cold-drink-416528/"
	authorUrl="https://www.pexels.com/@pixabay/"
/>

I **_just discovered_** (**_right now_**) that if I have **_invalid_** `JSX` in
one `Next.js` **_page component_**, and **_different_** `JSX` (which is
**_valid_** let’s say) in **_another_** `Next.js` **_page component_** which is
**_part_** of the **_same_** `UI`, I get a `hydration error`. Let’s say I
**_have_** the **_following_** in my `Home` (page) `component`:
...
When I **_went_** to the `browser` to **_check_** my `application`, I **_saw_**
the **_following error_**:

<br />
<Interglobalmedia
	src="/static/images/posts/img/webp/nextjs-hydration-error.webp"
	author="Interglobalmedia"
	alt="Next.js hydration error"
	srcUrl="/static/images/posts/img/webp/nextjs-hydration-error.webp"
	authorUrl="/about"
/>
...
> a [feature of React](https://reactjs.org/docs/react-dom.html#hydrate)
>
> This can cause the React tree to be out of sync with the DOM and result in
> unexpected content/attributes being present.
>
> While rendering your application, there was a difference between the React
> tree that was pre-rendered (SSR/SSG) and the React tree that rendered during
> the first render in the Browser. The first render is called Hydration which is
...
> NEXTJS. -
> <cite>[Bathila Sanvidu](https://stackoverflow.com/questions/71706064/react-18-hydration-failed-because-the-initial-ui-does-not-match-what-was-render/74201575#74201575)
> answered Oct 26 at 0:47</cite>
...
<br />
<Interglobalmedia
	src="/static/images/posts/img/webp/valid-jsx.webp"
	author="Interglobalmedia"
	alt="Valid JSX"
	srcUrl="/static/images/posts/img/webp/valid-jsx.webp"
	authorUrl="/about"
/>
