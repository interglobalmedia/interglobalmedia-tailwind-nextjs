...
lastmod: '2022-07-02'
tags:
  ['backend-development', 'mongodb-compass', 'robo-3-t', 'local-development', 'binary-image-data']
categories: ['binary-image-data', 'post']
draft: false
summary: Why I switched from MongoDB Compass to Robo 3T in local development.
images: ['/static/images/posts/img/webp/phillip-glickman-2umo15jszkm-unsplash.webp']
layout: PostLayout
