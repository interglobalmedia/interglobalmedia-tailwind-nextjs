...
categories: ['react', 'nextjs', 'post']
draft: false
summary:
    Applying how I created a Figure (element) component to creating a Static
    Text Tweet component.
images:
    ['/static/images/posts/img/webp/camilo-jimenez-0yLmwcXLwLw-unsplash.webp']
layout: PostLayout
canonicalUrl: /blog/applying-how-i-created-a-figure-element-component-to-creating-a-static-text-tweet-component
---

<Unsplash
	src="/static/images/posts/img/webp/camilo-jimenez-0yLmwcXLwLw-unsplash.webp"
	author="Camilo Jimenez"
	alt="Applying how I created a Figure element component to creating a Static Text Tweet component"
	srcUrl="https://unsplash.com/photos/0yLmwcXLwLw"
	authorUrl="https://unsplash.com/@camstejim"
/>
...
```jsx
mport StaticTextTweet from './StaticTextTweet'
