...
categories: ['html-5-video', 'post']
draft: false
summary: Creating a Custom HTML5 Video Player And The Shadow DOM.
images: ['/static/images/posts/img/webp/pexels-brian-machado-10626267.webp']
layout: PostLayout
canonicalUrl: /blog/2017-01-04-creating-a-custom-html5-video-player-and-the-shadow-dom
---

<Pexels
	src="/static/images/posts/img/webp/pexels-brian-machado-10626267.webp"
	author="Brian Machado"
	alt="Creating a Custom HTML5 Video Player And The Shadow DOM"
	srcUrl="https://www.pexels.com/photo/a-shadow-on-a-wooden-door-10626267/"
	authorUrl="https://www.pexels.com/@brian-machado-1551449/"
/>
...
-   [Fullscreen API](https://davidwalsh.name/fullscreen) So today I completed a
    `Custom HTML5 Video Player` **project**, including making the video go
    `full-screen`. I knew going in that there were cross-browser issues/bugs
    with the element, so I was very interested in finding out what would happen
    when I made the video go full-screen. Low and behold, when I first added
