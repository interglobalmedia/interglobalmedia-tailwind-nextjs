...
lastmod: '2022-07-15'
tags: ['homebrew', 'catalina', 'git']
categories: ['macos', 'homebrew', 'post']
draft: false
summary: When the Homebrew command brew update fails.
images: ['/static/images/posts/img/webp/pexels-engin-akyurt-1552630.webp']
layout: PostLayout
canonicalUrl: /blog/2019-12-22-when-the-homebrew-command-brew-update-fails
---

<Pexels
	src="/static/images/posts/img/webp/pexels-engin-akyurt-1552630.webp"
	author="Engin Akyurt"
	alt="When the Homebrew command brew update fails"
	srcUrl="https://www.pexels.com/photo/beer-filled-mug-on-table-1552630/"
