...
categories: ['vscode', 'vscode-extensions', 'rest-api', 'post']
draft: false
summary:
    Using a POST request in a local environment using VS Code's REST Client
    extension.
images:
    ['/static/images/posts/img/webp/sandra-harris-cT0PH_bkLlQ-unsplash.webp']
layout: PostLayout
canonicalUrl: /blog/2020-09-09-using-post-request-with-vs-codes-rest-client-extension
---

<Unsplash
	src="/static/images/posts/img/webp/sandra-harris-cT0PH_bkLlQ-unsplash.webp"
	author="Sandra Harris"
	alt="Using POST request with VS Code's REST Client"
	srcUrl="https://unsplash.com/photos/cT0PH_bkLlQ"
	authorUrl="https://unsplash.com/@girasolmom"
/>
...
![Screenshot of REST Client VS Code extension local environment POST request](/static/images/posts/img/webp/screen-shot-2020-09-09-at-7.25.24-am.webp)
