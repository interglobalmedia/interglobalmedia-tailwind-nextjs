...
categories: ['web-hosting', 'changing-web-hosts', 'post']
draft: false
summary:
    I recently changed my hosting for my business site to Netlify from gh-pages,
    but my Macbook Pro, which I use for development, does not point to the newly
    propagated site.
images: ['/static/images/posts/img/webp/mael-balland-1157034-unsplash.webp']
layout: PostLayout
canonicalUrl: /blog/why-your-computer-may-not-point-to-newly-propagated-site
---

<Unsplash
	src="/static/images/posts/img/webp/mael-balland-1157034-unsplash.webp"
	author="Mael Balland"
	alt="Why Your Local Machine (Computer) May Not be Pointing to Your Newly
    Propagated Site"
	srcUrl="https://unsplash.com/photos/f8r5L3b-hOQ"
	authorUrl="https://unsplash.com/@mael_balland"
/>
