---
title: Why Your Local Machine (Computer) May Not be Pointing to Your Newly Propagated Site
date: '2019-05-15'
lastmod: '2022-07-02'
tags: ['dns', 'local-hosts-file', 'ip-address', 'site-propagation', 'dns-information-groping']
categories: ['web-hosting', 'changing-web-hosts', 'post']
draft: false
summary: I recently changed my hosting for my business site to Netlify from gh-pages, but my Macbook Pro, which I use for development, does not point to the newly propagated site.
