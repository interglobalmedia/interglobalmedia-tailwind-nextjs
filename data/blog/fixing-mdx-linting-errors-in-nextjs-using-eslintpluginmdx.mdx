...
categories: ['nextjs', 'linting', 'git hooks', 'post']
draft: false
summary: Fixing MDX  Linting Errors in Next.js using eslint-plugin-mdx.
images: ['/static/images/posts/img/webp/pexels-polina-zimmerman-3747132.webp']
layout: PostLayout
canonicalUrl: /blog/fixing-mdx-linting-errors-in-nextjs-using-eslint-plugin-mdx
---

<Pexels
	src="/static/images/posts/img/webp/pexels-polina-zimmerman-3747132.webp"
	author="Polina Zimmerman"
	alt="Fixing MDX linting errors in Next.js using eslint-plugin-md"
	srcUrl="https://www.pexels.com/photo/black-smartphone-on-table-3747132/"
	authorUrl="https://www.pexels.com/@polina-zimmerman/"
/>
...
> <cite>btmills commented on Jul 22, 2020</cite>
