...
lastmod: '2022-07-15'
tags:
    ['automated-security-fixes', 'code-vulnerabilities', 'vulnerability-fixes']
categories: ['github', 'post', 'open-source-software', 'security']
draft: false
summary: Github automated security fixes and how they work.
images: ['/static/images/posts/img/webp/daniel-plan-kfq0kjskcx8-unsplash.webp']
layout: PostLayout
canonicalUrl: /blog/2019-07-29-github-automated-security-fixes-beta
---

<Unsplash
	src="/static/images/posts/img/webp/daniel-plan-kfq0kjskcx8-unsplash.webp"
	author="Daniel Plan"
	alt="Github automated security fixes (beta)"
	srcUrl="https://unsplash.com/photos/kFq0KJSKcX8"
	authorUrl="https://unsplash.com/@planiel"
/>

-   Link to
    [Github automated security fixes (beta) podcast on anchorfm](https://anchor.fm/maria-campbell/episodes/Github-automated-security-fixes-beta-e4peal)
