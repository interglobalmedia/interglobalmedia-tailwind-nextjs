...
date: '2019-06-22'
lastmod: '2022-07-15'
tags: ['google-chrome', 'browser-wars', 'privacy']
categories: ['web browsers', 'post']
draft: false
summary:
    Google Chrome has become surveillance software. It’s time to switch. But
    does Firefox stand up against it?
images: ['/static/images/posts/img/webp/ev-623589-unsplash.webp']
layout: PostLayout
canonicalUrl: /blog/browser-war-chrome-vs-firefox
---

<Unsplash
	src="/static/images/posts/img/webp/ev-623589-unsplash.webp"
	author="ev"
	alt="The Browser War: Chrome vs Firefox"
	srcUrl="https://unsplash.com/photos/gpjvRZyavZc"
	authorUrl="https://unsplash.com/@ev"
/>
