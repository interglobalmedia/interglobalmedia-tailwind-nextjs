...
draft: false
summary: Resources providing information about APIs for developers and what pitfalls to watch out for when working with APIs.
images: ['/static/images/posts/img/webp/michael-dziedzic-1bjsasjhfke-unsplash.webp']
layout: PostLayout
