...
lastmod: '2022-07-15'
tags: ['environment variables', 'dotenv', 'javascript']
categories: ['apis', 'frontend development', 'post']
draft: false
summary:
    Resources providing information about APIs for developers and what pitfalls
    to watch out for when working with APIs.
images:
    ['/static/images/posts/img/webp/michael-dziedzic-1bjsasjhfke-unsplash.webp']
layout: PostLayout
canonicalUrl: /blog/2020-01-14-apis-for-developers-and-what-pitfalls-to-watch-out-for
---

<Unsplash
	src="/static/images/posts/img/webp/michael-dziedzic-1bjsasjhfke-unsplash.webp"
	author="Michael Dziedzic"
	alt="APIs for Developers and what pitfalls to watch out for"
	srcUrl="https://unsplash.com/photos/1bjsASjhfkE"
