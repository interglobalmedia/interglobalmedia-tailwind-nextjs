...
draft: false
summary:
    During the past couple of days I have been working on adding a netlfiy-cms
    to my Gatsby site.
...
<Unsplash
	src="/static/images/posts/img/webp/andrew-neel-1-29wyvvLJA-unsplash.webp"
	author="Andrew Neel"
	alt="Gatsby, terser, and source-maps"
	srcUrl="https://unsplash.com/photos/1-29wyvvLJA"
	authorUrl="https://unsplash.com/@andrewtneel"
/>

-   Link to
    [Gatsby, terser, and source-maps podcast on anchorfm](https://anchor.fm/maria-campbell/episodes/Gatsby--terser--and-source-maps-e4ip7k)
