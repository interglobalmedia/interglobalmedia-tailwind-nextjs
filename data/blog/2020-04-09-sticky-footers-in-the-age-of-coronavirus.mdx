...
lastmod: '2022-07-15'
tags: ['viewport', 'vh', 'local-storage', 'web-storage-api']
categories: ['sticky-footer', 'flexbox', 'post']
draft: false
summary:
    A new way that I implemented Flexbox to achieve a sticky footer in the new
    application I created for my students called "Storage Fun With Forms".
images:
    ['/static/images/posts/img/webp/markus-winkler-zew4bp2gwva-unsplash.webp']
layout: PostLayout
canonicalUrl: /blog/2020-04-09-sticky-footers-in-the-age-of-coronavirus-it-always-comes-down-to-flexbox-just-the-implementation-may-vary
---

<Unsplash
	src="/static/images/posts/img/webp/markus-winkler-zew4bp2gwva-unsplash.webp"
	author="Markus Winkler"
	alt="Sticky Footers in the age of coronavirus"
	srcUrl="https://unsplash.com/photos/zew4BP2GWVA"
