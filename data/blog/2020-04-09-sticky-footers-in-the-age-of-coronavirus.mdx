...
draft: false
summary: A new way that I implemented Flexbox to achieve a sticky footer in the new application I created for my students called "Storage Fun With Forms".
images: ['/static/images/posts/img/webp/markus-winkler-zew4bp2gwva-unsplash.webp']
layout: PostLayout
    ...
    <div class="Site-content">
      <div class="note-taker">
        ...
        <div class="textarea-wrapper">
          <textarea name="text" class="session-storage" id="textArea" cols="50" rows="10">
