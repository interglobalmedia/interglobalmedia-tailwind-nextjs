...
date: '2019-06-21'
lastmod: '2022-07-15'
tags: ['macos dictation', 'mojave']
categories: ['macOS dictation', 'post']
draft: false
summary:
    The bug I encountered when typing non-alpha numeric characters in a text
    editor on my Mac, and how I came to fix the issue.
images: ['/static/images/posts/img/webp/luke-chesser-49-unsplash.webp']
layout: PostLayout
canonicalUrl: /blog/osx-dictation-and-text-editors
---

<Unsplash
	src="/static/images/posts/img/webp/luke-chesser-49-unsplash.webp"
	author="Luke Chesser"
	alt="The Apple dictation and text editors bug"
	srcUrl="https://unsplash.com/photos/1uxV8fAfhVM"
	authorUrl="https://unsplash.com/@lukechesser"
/>

-   Link to
    [The Apple dictation and text editors bug podcast on anchorfm](https://anchor.fm/maria-campbell/episodes/The-Apple-dictation-and-text-editors-bug-e4dgid)
