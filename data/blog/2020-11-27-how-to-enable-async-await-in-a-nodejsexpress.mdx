...
summary:
    ...
    application.
images: ['/static/images/posts/img/webp/jay-clark-Vh5LC_xYd28-unsplash.webp']
layout: PostLayout
canonicalUrl: /blog/2020-11-27-how-to-enable-async-await-in-a-node-js-express-application-with-eslint
---

<Unsplash
	src="/static/images/posts/img/webp/jay-clark-Vh5LC_xYd28-unsplash.webp"
	author="Jay Clark"
	alt="How to enable async await in a Node.js/Express"
	srcUrl="https://unsplash.com/photos/Vh5LC_xYd28"
	authorUrl="https://unsplash.com/@jayclark"
/>
