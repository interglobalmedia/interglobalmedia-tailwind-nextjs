---
title: Adding Husky to a subfolder of a Git root repository
date: '2023-01-14'
lastmod: '2023-01-14'
tags: ['husky', 'git hooks']
categories: ['git hooks', 'post']
draft: false
summary: Adding Husky to a subfolder of a Git root repository.
images: ['/static/images/posts/img/webp/pexels-pixabay-36430.webp']
layout: PostLayout
canonicalUrl: /blog/adding-husky-to-a-subfolder-of-a-git-root-repository
---

<Pexels
	src="/static/images/posts/img/webp/pexels-pixabay-36430.webp"
	author="Pixabay"
	alt="Chicks in nest representing adding Husky to a subfolder of a Git root repository"
	srcUrl="https://www.pexels.com/photo/nature-animal-cute-sitting-36430/"
...
contains_** a `.gitignore file` and a `husky.sh file`. And `/` after `_` denotes
the `absolute path` to `husky.sh` inside the `_` `directory`.
