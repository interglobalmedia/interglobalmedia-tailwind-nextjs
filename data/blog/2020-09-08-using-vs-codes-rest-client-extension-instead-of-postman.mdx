...
images: ['/static/images/posts/img/webp/mick-haupt-fVzrhGkLLaY-unsplash.webp']
layout: PostLayout
canonicalUrl: /blog/2020-09-08-using-vs-codes-rest-client-extension-instead-of-postman
---

<Unsplash
	src="/static/images/posts/img/webp/mick-haupt-fVzrhGkLLaY-unsplash.webp"
	author="Mick Haupt"
	alt="Using VS Code's REST Client extension instead of Postman"
	srcUrl="https://unsplash.com/photos/fVzrhGkLLaY"
