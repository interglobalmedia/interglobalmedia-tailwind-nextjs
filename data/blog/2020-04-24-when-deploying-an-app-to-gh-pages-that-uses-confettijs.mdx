...
lastmod: '2022-07-15'
tags: ['confetti js']
categories: ['gh pages', 'npm packages', 'post']
draft: false
summary:
    How to add the confetti-js npm package to an application you are hosting on
    Github gh-pages.
images: ['/static/images/posts/img/webp/hugo-ruiz-e2pvre1pyzs-unsplash.webp']
layout: PostLayout
canonicalUrl: /blog/2020-04-24-when-deploying-an-app-to-gh-pages-that-uses-confetti-js
---

<Unsplash
	src="/static/images/posts/img/webp/hugo-ruiz-e2pvre1pyzs-unsplash.webp"
	author="Hugo Ruiz"
	alt="When deploying an app to gh-pages that uses confetti-js"
	srcUrl="https://unsplash.com/photos/e2pVrE1PYzs"
	authorUrl="https://unsplash.com/@2hrrc"
/>
