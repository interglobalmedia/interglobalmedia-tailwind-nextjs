...
categories: ['python3', 'post']
draft: false
summary: Installing Python 3.8.0+ on your Mac with pyenv.
images:
    ['/static/images/posts/img/webp/romina-farias-o4-cizsljeg-unsplash.webp']
layout: PostLayout
canonicalUrl: /blog/2020-06-30-installing-python-3-8-0-on-your-mac-with-pyenv
---

<Unsplash
	src="/static/images/posts/img/webp/romina-farias-o4-cizsljeg-unsplash.webp"
	author="Romina Farias"
	alt="Installing Python 3.8.0+ on your Mac with pyenv"
	srcUrl="https://unsplash.com/photos/O4-cizslJeg"
	authorUrl="https://unsplash.com/@rominafa"
/>
