...
categories: ['google search', 'post']
draft: false
summary:
    Yesterday I pretty much completed the site. There are still things to do,
    add, etc. But that will happen over time as needed.
images: ['/static/images/posts/img/webp/fredy-jacob-764477-unsplash.webp']
layout: PostLayout
canonicalUrl: /blog/outdated-content-and-google-custom-search
---

<Unsplash
	src="/static/images/posts/img/webp/fredy-jacob-764477-unsplash.webp"
	author="Fredy Jacob"
	alt="Outdated Content And Google Custom Search"
	srcUrl="https://unsplash.com/photos/t0SlmanfFcg"
	authorUrl="https://unsplash.com/@thefredyjacob"
/>

**Note 7.15.22**: This post **_refers_** to my **_previous iteration_** of
`interglobalmedianetwork.com` **_built_** with `GatsbyJS`.
...
![Removing outdated content from Google Search](/static/images/posts/img/webp/remove-outdated-content.webp)
