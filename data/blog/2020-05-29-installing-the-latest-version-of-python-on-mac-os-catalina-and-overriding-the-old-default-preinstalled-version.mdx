...
lastmod: '2022-07-15'
tags: ['python3']
categories: ['macOs', 'catalina', 'python3', 'post']
draft: false
summary:
    How to replace the old pre-installed default version of Python on Mac OS
    with the latest version of Python via Homebrew.
images: ['/static/images/posts/img/webp/david-clode-6f9-eaybja-unsplash.webp']
layout: PostLayout
canonicalUrl: /blog/2020-05-29-installing-the-latest-version-of-python-on-mac-os-catalina-and-overriding-the-old-default-pre-installed-version
---

<Unsplash
	src="/static/images/posts/img/webp/david-clode-6f9-eaybja-unsplash.webp"
	author="David Clode"
	alt="Installing the latest version of Python on Mac OS Catalina and overriding
    the old default pre-installed version"
	srcUrl="https://unsplash.com/photos/-6f9-eAybjA"
