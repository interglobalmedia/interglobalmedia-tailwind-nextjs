...
![Installing the latest version of Python on Mac OS Catalina and overriding the old default pre-installed version](/static/images/posts/img/webp/david-clode-6f9-eaybja-unsplash.webp)
