...
This **_post_** was **_first published_** on my `Next Blog`
[mariadcampbell.com](https://www.mariadcampbell.com/posts/nextjs-environment-variable-support-and-the-envlocal-file)
...
**_be able_** to **_extract_** one’s `environment variable` **_values_** from
