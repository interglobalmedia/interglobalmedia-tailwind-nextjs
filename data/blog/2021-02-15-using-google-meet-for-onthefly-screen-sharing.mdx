...
categories: ['screen-sharing', 'video-conferencing', 'post']
draft: false
summary:
    How one can use the Google Meet video conferencing app with screen sharing
    capability.
images:
    ['/static/images/posts/img/webp/joshua-sortino-71vab1fxb6g-unsplash.webp']
layout: PostLayout
canonicalUrl: /blog/2021-02-15-using-google-meet-for-on-the-fly-screen-sharing
---

<Unsplash
	src="/static/images/posts/img/webp/joshua-sortino-71vab1fxb6g-unsplash.webp"
	author="Joshua Sortino"
	alt="Using Google Meet for on-the-fly screen sharing"
	srcUrl="https://unsplash.com/photos/71vAb1FXB6g"
