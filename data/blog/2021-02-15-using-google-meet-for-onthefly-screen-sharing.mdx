...
draft: false
summary: How one can use the Google Meet video conferencing app with screen sharing capability.
images: ['/static/images/posts/img/webp/joshua-sortino-71vab1fxb6g-unsplash.webp']
layout: PostLayout
