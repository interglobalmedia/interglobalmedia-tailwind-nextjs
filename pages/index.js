				...
				<article className="home-page-title-wrapper space-y-2 pt-6 pb-8 md:space-y-5">
					...
					<p className="home-page-description text-lg leading-7 text-gray-500 dark:text-gray-400">
						<span className="realistic-marker-highlight">
							...
							<b className="intro-highlight">
								Inter-Global Media Network.
							</b>{' '}
							I'm <b className="intro-highlight">Maria,</b> and I{' '}
							<b className="intro-highlight">design,</b>{' '}
							<b className="intro-highlight">develop,</b> and{' '}
							<b className="intro-highlight">teach experiences</b>
							that <b className="intro-highlight">make</b>{' '}
							people's lives{' '}
